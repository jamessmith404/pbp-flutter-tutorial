                      ...
                      child: Column(
                          ...
                          CheckboxListTile(
                              ...
                              setState(() {
                                  ...
                                  jenjangDipilih = "Sarjana"; // TAMBAHAN
                                  if (value){
                          ...
                          CheckboxListTile(
                              ...
                              setState(() {
                                  ...
                                  jenjangDipilih = "Diploma"; // TAMBAHAN
                                  if (value){
                          ...
                          CheckboxListTile(
                              ...
                              setState(() {
                                  ...
                                  jenjangDipilih = "Magister"; // TAMBAHAN
                                  if (value){
                          ...
                          CheckboxListTile(
                              ...
                              setState(() {
                                  jenjangDoktor = value!;
                                  jenjangDipilih = "Doktor"; // TAMBAHAN
                                  if (value){
                                  ...
                                  child: Container(
                                    child: ListView(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text('Judul: ' + _namaLengkap), // from lab07 docs
